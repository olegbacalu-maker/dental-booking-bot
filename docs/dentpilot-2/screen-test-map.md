...
Маршрутов **126** · наборов **27** · мест вызова `res.ok`/`res.check` в исходниках — **1915**.
...
| `POST /admin/lan/save` | HTML | 11 | admin, settings_api | 456 | — | — |
| `GET /admin/settings` | HTML | 19 | admin, api, pin, settings_api, theme | 703 | settings_hub | off |
| `GET /admin/settings/backup` | HTML | 17 | **—** | — | — | — |
| `GET /admin/settings/clinic` | HTML | 27 | admin, api, doctors, settings_api | 633 | settings_clinic | off |
| `GET /admin/settings/crypt` | HTML | 66 | settings_api | 80 | — | — |
...
| `GET /admin/settings/faq` | HTML | 9 | admin, dbcrypt, pin, settings_api | 636 | settings_faq | off |
| `GET /admin/settings/hours` | HTML | 63 | admin, settings_api | 456 | settings_hours | off |
| `GET /admin/settings/lan` | HTML | 9 | admin, settings_api | 456 | settings_lan | off |
| `POST /admin/settings/save` | 303 | 38 | admin, api, pin, review2, settings_api, theme | 722 | — | — |
| `GET /admin/settings/security` | HTML | 26 | pin, review2 | 122 | — | — |
| `GET /admin/settings/services` | HTML | 115 | admin, review2, settings_api | 475 | — | — |
| `GET /admin/settings/system` | HTML | 80 | admin, pin, settings_api | 559 | — | — |
| `GET /admin/settings/telegram` | HTML | 19 | admin, settings_api | 456 | — | — |
| `GET /admin/settings/theme` | HTML | 135 | settings_api, theme | 155 | — | — |
...
| `POST /admin/users/save` | other | 28 | api, doctors, migrate, pin, review2, review3_auth, settings_api | 556 | — | — |
| `GET /api/settings/clinic` | JSON | 4 | api | 69 | — | — |
| `POST /api/settings/clinic` | JSON | 25 | api | 69 | — | — |
| `GET /api/settings/faq` | JSON | 4 | settings_api | 80 | — | — |
| `GET /api/settings/hours` | JSON | 4 | settings_api | 80 | — | — |
| `POST /api/settings/hours` | JSON | 16 | settings_api | 80 | — | — |
| `GET /api/settings/hub` | JSON | 6 | settings_api | 80 | — | — |
| `GET /api/settings/lan` | JSON | 6 | settings_api | 80 | — | — |
| `POST /api/settings/lan` | JSON | 21 | settings_api | 80 | — | — |
| `POST /api/settings/lan/firewall` | JSON | 8 | settings_api | 80 | — | — |
...
| `POST /admin/doctor-card/{dk}/save` | 303 | 14 | admin, anamneza, api, doctors, migrate, pin, plan_acord, privacy, review2, review3, review3_auth, settings_api, theme, visit | 1331 | — | — |
| `POST /admin/doctor-card/{dk}/services` | 303 | 7 | admin, doctors, pin, review2, review3, settings_api | 722 | — | — |
| `GET /admin/doctor-photo/{dk}` | FILE | 9 | doctors | 108 | — | — |
| `GET /admin/medici` | HTML | 48 | admin, doctors, pin, settings_api | 667 | doctors_list | off |
...
| `POST /api/doctors/{dk}/services` | JSON | 11 | admin, doctors, review2, review3, settings_api | 619 | — | — |
...
| `GET /qr` | other | 5 | settings_api | 80 | — | — |
...
| `POST /admin/patient/{pid}/save` | 303 | 56 | activity, admin, anamneza, api, booking, bot, doctors, hardening, migrate, perio, pin, plan_acord, privacy, review2, review3_auth, settings_api, teeth, theme, visit | 1675 | — | — |
...
| Маршрут | Тип | стр | Наборы | Проверок | Флаг | Пилот |
|---|---|---|---|---|---|---|
| `GET /admin` | HTML | 162 | admin, api, booking, dbcrypt, doctors, hardening, migrate, pin, review3_auth, settings_api, theme | 1225 | — | — |
...
| Маршрут | Тип | стр | Наборы | Проверок | Флаг | Пилот |
|---|---|---|---|---|---|---|
| `GET /` | HTML | 6 | activity, admin, anamneza, booking, bot, dbcrypt, doctor_windows, doctors, guards, hardening, launcher, migrate, perio, pin, plan_acord, privacy, restart, review2, review3, review3_auth, review3_bot, settings_api, structure, teeth, theme, visit | 1846 | — | — |
| `GET /admin/login` | HTML | 34 | admin, api, doctors, hardening, migrate, pin, review3_auth, settings_api, theme | 1062 | — | — |
| `POST /admin/login` | 303 | 66 | admin, api, doctors, hardening, migrate, pin, review3_auth, settings_api, theme | 1062 | — | — |
...
| `GET /admin/setup` | HTML | 12 | api, doctors, hardening, migrate, pin, review2, review3_auth, settings_api | 630 | — | — |
| `POST /admin/setup` | HTML | 17 | api, doctors, hardening, migrate, pin, review2, review3_auth, settings_api | 630 | — | — |
...
| `GET /static/{kind}/{name}` | other | 28 | admin, api, doctors, settings_api | 633 | — | — |
...
| 135 | `GET /admin/settings/theme` | 2 |
| 115 | `GET /admin/settings/services` | 3 |
