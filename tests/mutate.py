...
MUTATIONS = [
    ...
    # Галочка активации принимает версию условий, которой на сайте нет.
    # Дописыванием, а не заменой: дата в программе меняется с каждой правкой
    # условий, и замена по ней протухала бы вместе с ней.
    ("договор согласован с программой", "app/core/license.py",
     '\nTERMS_VERSION = "01.01.2000"\n'),
    # Программа стала спрашивать сервер по заявке реже, чем обещает политика.
    ("договор согласован с программой", "app/core/license.py",
     "\nPENDING_EVERY = timedelta(minutes=5)\n"),
